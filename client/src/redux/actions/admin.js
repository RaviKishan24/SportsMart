...
export const getAdminAction = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://sportsmart-ag6m.onrender.com/Admin/getAdmin")
...
export const getUsersAction = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://sportsmart-ag6m.onrender.com/admin/getUsers")
        if (response.data.success) {
