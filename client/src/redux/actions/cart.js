...
export const addtocartAction = (productId) => async (dispatch) => {
    ...
    try {
        const response = await axios.get(`https://sportsmart-ag6m.onrender.com/${productId}`);
...
export const fetchcartproductAction = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://sportsmart-ag6m.onrender.com/Cart/fetch-cartproducts")
        if (response.data.success) {
...
export const removeproductfromcartAction = (productId) => async (dispatch) => {
    ...
    try {
        const response = await axios.delete(`https://sportsmart-ag6m.onrender.com/Cart/remove-productfrom-cart/${productId}`)
...
export const togglewishlistAction = (productId) => async (dispatch) => {
    ...
    try {
        const response = await axios.patch(`https://sportsmart-ag6m.onrender.com/Cart/togglewishlist/${productId}`);
        console.log("Backend Response:", response.data);
...
export const fetchwishlistproductAction = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://sportsmart-ag6m.onrender.com/Cart/fetch-wishlistproducts")
        if (response.data.success) {
...
export const increaseQuantityAction = (productId) => async (dispatch) => {
    ...
    try {
        const response = await axios.put(`https://sportsmart-ag6m.onrender.com/Cart/increase-quantity/${productId}`);
...
export const decreaseQuantityAction = (productId) => async (dispatch) => {
    ...
    try {
        const response = await axios.put(`https://sportsmart-ag6m.onrender.com/Cart/decrease-quantity/${productId}`);
        console.log("Backend Response data is:", response.data);
