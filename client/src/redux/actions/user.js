...
export const registerUserAction = (formData, navigate) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/SignUp", formData);
...
export const otpVerifiactionAction = (formData, navigate) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/otpVerification", formData);
        if (response.data.success) {
...
export const resendOtpAction = (email) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/resend-otp", { email });
...
export const LoginAction = (formData, navigate) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/login", formData);
        if (response.data.success) {
    ...
    export const logoutAction = (navigate) => async (dispatch) => {
        ...
        try {
            const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/logout");
            if (response.data.success) {
...
export const sendotpAction = (email) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/password-Change", { email })
...
export const verifyOTPAction = (otp) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/otp-verify", { otp })
...
export const updatepasswordAction = (password) => async (dispatch) => {
    ...
    try {
        const response = await axios.patch("https://sportsmart-ag6m.onrender.com/Auth/update-password", { password })
...
export const getUserAction = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://sportsmart-ag6m.onrender.com/Auth/getuser")
        if (response.data.success) {
...
export const addAddressAction = (formData) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/Auth/addAddress", formData)
        if (response.data.success) {
...
export const getAddressAction = () => async (dispatch) => {
    ...
    try {
        const response = await axios.get("https://sportsmart-ag6m.onrender.com/Auth/getAddress")
        if (response.data.success) {
...
export const placeOrderAction = (navigate) => async (dispatch) => {
    ...
    try {
        const response = await axios.post("https://sportsmart-ag6m.onrender.com/orders");
